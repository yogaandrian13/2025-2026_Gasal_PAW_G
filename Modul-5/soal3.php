            ...
            if(isset($_GET['id'])){
                ...
                <form action="" method="POST">
                    <fieldset>
                        ...
                        <label>Nama Supplier <input type="text" name="nama" value="<?php echo $_GET['nama'] ?>" /></label> 
                        <span><?= $errors['nama'] ?? "" ?></span><br>
                        <label>No. Telepon <input type="text" name="telp" value="<?php echo $_GET['telp'] ?>"/></label>
                        <span><?= $errors['telp'] ?? "" ?></span><br>
                        <label>Alamat <input type="text" name="alamat" value="<?php echo $_GET['alamat'] ?>" /></label>
                        <span><?= $errors['alamat'] ?? "" ?></span><br>
                        <br>
                        <label>
                            <input type="submit" name="btn_ubah" value="ubah" />
                        </label>
                        <br>
                    </fieldset>
                </form>
